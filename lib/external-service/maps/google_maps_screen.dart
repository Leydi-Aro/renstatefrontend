...
import 'package:renstatefrontend/external-service/utils/constans.dart';
import 'package:renstatefrontend/external-service/utils/utils.dart';
...
class _GoogleMapsScreenState extends State<GoogleMapsScreen> {
  ...
  Future<void> setIcon() async {
    Uint8List iconBytes = (await Utils.getBytesFromAsset(kMarker, 120)) as Uint8List;
